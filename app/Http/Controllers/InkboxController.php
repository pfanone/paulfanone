...
class InkboxController extends BaseController
{
	...
	public function postUserdata() {
		...
		$select = DB::select('SELECT 0 AS `type`, "All" AS `interval`, "" `date_as_of`, count(*) AS `count` FROM `users`'
			. ' UNION'
			. ' SELECT 1 AS `type`, "Month" AS `interval`, DATE_SUB(CURRENT_DATE, INTERVAL 1 MONTH) AS `date_as_of`, count(*) AS `count` FROM `users` WHERE `last_login` BETWEEN DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 1 MONTH) AND CONVERT_TZ(NOW(), "GMT", "EST")'
			. ' UNION'
			. ' SELECT 1 AS `type`, "Week" AS `interval`, DATE_SUB(CURRENT_DATE, INTERVAL 1 WEEK) AS `date_as_of`, count(*) AS `count` FROM `users` WHERE `last_login` BETWEEN DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 1 WEEK) AND CONVERT_TZ(NOW(), "GMT", "EST")'
			. ' UNION'
			. ' SELECT 1 AS `type`, "Day" AS `interval`, DATE_SUB(CURRENT_DATE, INTERVAL 1 DAY) AS `date_as_of`, count(*) AS `count` FROM `users` WHERE `last_login` BETWEEN DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 1 DAY) AND CONVERT_TZ(NOW(), "GMT", "EST")'
			. ' UNION'
			. ' SELECT 2 AS `type`, "Month" AS `interval`, DATE_SUB(CURRENT_DATE, INTERVAL 1 MONTH) AS `date_as_of`, count(*) AS `count` FROM `users` WHERE `last_login` BETWEEN DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 2 MONTH) AND DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 1 MONTH)'
			. ' UNION'
			. ' SELECT 2 AS `type`, "Week" AS `interval`, DATE_SUB(CURRENT_DATE, INTERVAL 1 WEEK) AS `date_as_of`, count(*) AS `count` FROM `users` WHERE `last_login` BETWEEN DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 2 WEEK) AND DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 1 WEEK)'
			. ' UNION'
			. ' SELECT 2 AS `type`, "Day" AS `interval`, DATE_SUB(CURRENT_DATE, INTERVAL 1 DAY) AS `date_as_of`, count(*) AS `count` FROM `users` WHERE `last_login` BETWEEN DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 2 DAY) AND DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 1 DAY)', array());
	...
	public function postTattoodata() {
		...
		$select = DB::select('SELECT 0 AS `type`, "All" AS `interval`, "" `date_as_of`, count(*) AS `count` FROM `designs`'
			. ' UNION'
			. ' SELECT 1 AS `type`, "Month" AS `interval`, DATE_SUB(CURRENT_DATE, INTERVAL 1 MONTH) AS `date_as_of`, count(*) AS `count` FROM `designs` WHERE `date_created` BETWEEN DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 1 MONTH) AND CONVERT_TZ(NOW(), "GMT", "EST")'
			. ' UNION'
			. ' SELECT 1 AS `type`, "Week" AS `interval`, DATE_SUB(CURRENT_DATE, INTERVAL 1 WEEK) AS `date_as_of`, count(*) AS `count` FROM `designs` WHERE `date_created` BETWEEN DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 1 WEEK) AND CONVERT_TZ(NOW(), "GMT", "EST")'
			. ' UNION'
			. ' SELECT 1 AS `type`, "Day" AS `interval`, DATE_SUB(CURRENT_DATE, INTERVAL 1 DAY) AS `date_as_of`, count(*) AS `count` FROM `designs` WHERE `date_created` BETWEEN DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 1 DAY) AND CONVERT_TZ(NOW(), "GMT", "EST")'
			. ' UNION'
			. ' SELECT 2 AS `type`, "Month" AS `interval`, DATE_SUB(CURRENT_DATE, INTERVAL 1 MONTH) AS `date_as_of`, count(*) AS `count` FROM `designs` WHERE `date_created` BETWEEN DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 2 MONTH) AND DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 1 MONTH)'
			. ' UNION'
			. ' SELECT 2 AS `type`, "Week" AS `interval`, DATE_SUB(CURRENT_DATE, INTERVAL 1 WEEK) AS `date_as_of`, count(*) AS `count` FROM `designs` WHERE `date_created` BETWEEN DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 2 WEEK) AND DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 1 WEEK)'
			. ' UNION'
			. ' SELECT 2 AS `type`, "Day" AS `interval`, DATE_SUB(CURRENT_DATE, INTERVAL 1 DAY) AS `date_as_of`, count(*) AS `count` FROM `designs` WHERE `date_created` BETWEEN DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 2 DAY) AND DATE_SUB(CONVERT_TZ(NOW(), "GMT", "EST"), INTERVAL 1 DAY)', array());
